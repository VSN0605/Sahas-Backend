...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['id'], $_POST['type'], $_FILES['image'])) {
        $id = $_POST['id'];
        $type = $_POST['type'];
        
        // Handle file upload
        $image = $_FILES['image'];
        $uploadDir = 'ugallery/'; // Change this to your desired upload directory
        ...
        if (move_uploaded_file($image['tmp_name'], $destination)) {
            ...
            $sql = "UPDATE gallery SET type='$type', image='$filename' WHERE id=$id";
